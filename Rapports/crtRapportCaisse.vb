...
Public Class crtRapportCaisse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.crtRapportCaisse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtRapportCaisse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtRapportCaisse = New crtRapportCaisse()
        rpt.Site = Me.Site
        Return rpt
    End Function
