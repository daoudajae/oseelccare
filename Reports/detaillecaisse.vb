...
Public Class detaillecaisse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.detaillecaisse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddetaillecaisse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As detaillecaisse = New detaillecaisse()
        rpt.Site = Me.Site
        Return rpt
    End Function
