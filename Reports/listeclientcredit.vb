...
Public Class listeclientcredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.listeclientcredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlisteclientcredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listeclientcredit = New listeclientcredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
