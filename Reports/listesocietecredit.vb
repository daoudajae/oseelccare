...
Public Class listesocietecredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.listesocietecredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlistesocietecredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listesocietecredit = New listesocietecredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
