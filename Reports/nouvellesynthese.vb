...
Public Class nouvellesynthese
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.nouvellesynthese.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednouvellesynthese
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nouvellesynthese = New nouvellesynthese()
        rpt.Site = Me.Site
        Return rpt
    End Function
