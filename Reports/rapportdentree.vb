...
Public Class rapportdentree
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.rapportdentree.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrapportdentree
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rapportdentree = New rapportdentree()
        rpt.Site = Me.Site
        Return rpt
    End Function
