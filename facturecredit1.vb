...
Public Class facturecredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSEELCCare.facturecredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfacturecredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As facturecredit = New facturecredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
